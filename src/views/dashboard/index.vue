  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imagerroe="img" :src="staffPhoto">
          </div>
    ...
    <!-- 弹出层 -->
    <el-dialog :visible="showDialog" title="离职申请" @close="Cancel">
      <el-form
        ref="ruleForm"
        :model="ruleForm"
        status-icon
      ...
      <el-row slot="footer" type="flex" justify="center">
        <el-col :span="6">
          <el-button size="small" type="primary" @click="dimission">确定</el-button>
...
import WorkCanlendar from './components/work-calendar'
